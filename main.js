...
console.log("末尾追加前", array3);
array3.push("コメント4");
console.log("末尾追加後", array3);
...
console.log("末尾取り除く前", array4);
const poppedValue = array4.pop();
console.log("末尾取り除いた後", array4);
console.log("末尾取り除いた値", poppedValue);
...
const array5 = ["タスク1", "タスク２", "タスク３"];
console.log("先頭追加前", array5);
array5.unshift("最優先タスク");
console.log("先頭追加後", array5);
...
console.log("先頭取り除く前", array6);
const shiftedValue = array6.shift();
console.log("先頭取り除いた後", array6);
console.log("先頭取り除いた値", shiftedValue);